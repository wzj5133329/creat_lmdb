...
def main(argv):
    ...
    parser.add_argument('-filelist', default = r'/home/asd/Project/NCC_WZJ/YOLO/train/NCC/train.txt',
                        help='path to filelist\n' )
    parser.add_argument('-output_dir', default = r'/home/asd/Project/NCC_WZJ/YOLO/train/NCC', type = str,
    ...
    parser.add_argument('-yolo_input_shape', default=320, type=int,
    ...
    for line in lines:
        line = line.replace('image','labels')
